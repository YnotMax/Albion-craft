      ...
      {filteredFavorites.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredFavorites.map(calc => {
            ...
            if (calc.item.category.includes('Tecido')) categoryAccent = 'bg-emerald-500';
            else if (calc.item.category.includes('Couro')) categoryAccent = 'bg-orange-500';
            else if (calc.item.category.includes('Placa')) categoryAccent = 'bg-blue-500';
            else if (['Lanças', 'Espadas', 'Arcos', 'Adagas'].includes(calc.item.category)) categoryAccent = 'bg-red-500';
            else if (calc.item.category === 'Diários') categoryAccent = 'bg-purple-500';
